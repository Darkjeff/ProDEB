 ...
 */
class exportprodebbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "exportprodeb@exportprodeb";
    public $boxlabel;
    public $depends = array("exportprodeb");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/exportprodeb/class/exportprodeb.class.php";
